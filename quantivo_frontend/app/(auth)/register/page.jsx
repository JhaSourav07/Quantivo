      ...
      >
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-7 shadow-[0_24px_64px_rgba(0,0,0,0.5)]">
          ...
          <div className="mt-5 pt-4 border-t border-zinc-800 grid grid-cols-2 gap-2">
            {['Real-time analytics','Inventory tracking','Order management','Profit reports'].map(f => (
              <div key={f} className="flex items-center gap-1.5 text-xs text-zinc-600">
                <svg className="w-3 h-3 text-indigo-500 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>

...
export default function VerifyEmailPage() {
  return (
    <>
      ...
      <div style={{ minHeight:'100vh', display:'flex', alignItems:'center', justifyContent:'center', background:'#05050d', fontFamily:'Syne, sans-serif', padding:'24px', position:'relative', overflow:'hidden' }}>
        <Suspense fallback={<div className="text-zinc-400 text-center p-8">Loading...</div>}>
          <VerifyEmailContent />
        </Suspense>
      </div>
    </>
